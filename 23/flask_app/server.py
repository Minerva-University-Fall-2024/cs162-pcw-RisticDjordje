...
def dashboard():
    ...
    return render_template_string(
        "<!-- HTML to display the dashboard and history -->",
        expressions=expressions,  # noqa
    )
...
def safe_evaluate(expression):
    # Implement the logic to parse and evaluate the expression safely
    # For example, you can use the `eval` function with proper error handling
    try:
...
def evaluate():
    ...
    result = str(safe_evaluate(expression))
